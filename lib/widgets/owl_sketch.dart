...
class OwlSketch extends StatelessWidget {
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 150" fill="none">
  ...
  <ellipse cx="50" cy="45" rx="3.4" ry="4.2" fill="$hex" />
  <ellipse cx="70" cy="45" rx="3.4" ry="4.2" fill="$hex" />
  ...
  Widget build(BuildContext context) {
    final hex = '#${ink.value.toRadixString(16).padLeft(8, '0').substring(2)}';
    return SvgPicture.string(
      _svg(hex),
      width: size,
      height: size * 1.25, // même proportion que sur le site
    );
  }
}
