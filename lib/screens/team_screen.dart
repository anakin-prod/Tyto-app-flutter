          ...
          : _team == null
              ...
              : ListView(
                  ...
                  children: [
                    ...
                    Text('Inviter un soigneur', style: TytoText.display(size: 17)),
                    ...
                    Text('Soigneurs', style: TytoText.display(size: 17)),
                    const SizedBox(height: 8),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TytoText.ui(size: 14, weight: FontWeight.w700, color: TytoColors.lune),
          ),
          if (t.seatsExtra > 0) ...[
      ...
      child: Row(
        children: [
          Icon(
            ...
            size: 18,
            color: actif ? TytoColors.vert : TytoColors.brume,
          ),
          ...
          IconButton(
            icon: const Icon(Icons.close_rounded, size: 18, color: TytoColors.brume),
            tooltip: 'Retirer',
